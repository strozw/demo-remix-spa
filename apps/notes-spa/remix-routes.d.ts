declare module "remix-routes" {
  ...
  export interface Routes {
    ...
    "/folders/:folderId/destroy": {
      ...
      query: ExportedQuery<
        import("src/app/routes/folders.$folderId.destroy").SearchParams
      >;
    };
    ...
    "/folders/:folderId/notes": {
      ...
      query: ExportedQuery<
        import("src/app/routes/folders.$folderId.notes").SearchParams
      >;
    };
    ...
    "/folders/uncategorized/notes": {
      params: never;
      query: ExportedQuery<
        import("src/app/routes/folders.uncategorized.notes").SearchParams
      >;
    };
    ...
    "/notes/:noteId/destroy": {
      ...
      query: ExportedQuery<
        import("src/app/routes/notes.$noteId.destroy").SearchParams
      >;
    };
